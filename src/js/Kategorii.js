...
import { getKomplexpredlinfodesc, putKategorii, putKategorii1 } from "../https/deviceAPI";
...
if(setsvgRef.current==setsvg1Ref.current){
   ...
   get()
    ...
    return (
<div class="col-12 col-xl-6 top2 ">
<div class="features__item">

  <img class={`input_1${i.id} fill pd`}  src={process.env.REACT_APP_API_URL + setsvgRef.current}/>
...
class={`input_${i.id} file`}
  ...
  <div class="features__item-content">
    ...
    <div class={`input_1${i.id} input_1 features__item-text aos-init aos-animate color_new_2"`} data-aos="fade-left" data-aos-delay="100">   {setdescriptionRef.current}</div>
