...
import { getGlav_text, getKategorii, getO_sebe_info, getUslugi, getUslugi_price } from './https/deviceAPI';
function App1({i}) {

  
    const[isLike, setIsLike] = useState(false);
    const colorStyle = {background :"#FFF"}
    ...
    return (
        ...
        <div onClick={function1} style={isLike ? colorStyle : null} class='but w_100 but_2  ml_5'>
        <div>
